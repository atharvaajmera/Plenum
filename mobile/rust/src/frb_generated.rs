...
fn wire__crate__api__plenum_api__cancel_session_impl(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok({
                    crate::api::plenum_api::cancel_session(api_session_token);
                })?;
                Ok(output_ok)
            })())
        },
...
fn wire__crate__api__plenum_api__respond_to_incoming_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "respond_to_incoming",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok({
                    crate::api::plenum_api::respond_to_incoming(api_session_token, api_accept);
                })?;
                Ok(output_ok)
            })())
        },
...
fn wire__crate__api__plenum_api__start_discovery_impl(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok =
                            crate::api::plenum_api::start_discovery(api_sink, api_timeout_secs)?;
                        Ok(output_ok)
                    })(),
                )
            }
...
fn wire__crate__api__plenum_api__start_receive_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_announce = <bool>::sse_decode(&mut deserializer);
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::plenum_api::start_receive(
                            api_sink,
                            api_session_token,
                            api_output_dir,
                            api_port,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::plenum_api::start_send(
                            api_sink,
                            api_session_token,
                            api_file_path,
                            api_peer_address,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__plenum_api__cancel_session_impl(ptr, rust_vec_len, data_len),
        2 => wire__crate__api__plenum_api__generate_peer_id_sync_impl(ptr, rust_vec_len, data_len),
        3 => {
